...
@Component({
  selector: 'app-operations-de-saisie',
  templateUrl: './operations-de-saisie.component.html',
  styleUrls: ['./operations-de-saisie.component.scss']
})
export class OperationsDeSaisieComponent {
  title!: string;
  typeMenuID!: number;
  agent!: Agent
  ...
  initMenusForComptabilite(){
    ...
    this.menus = [
      ...
      // },
      {
        ...
        right: this.agent.CaisseAssociee > 0 ? true : false
      }
    ]
  }
}
