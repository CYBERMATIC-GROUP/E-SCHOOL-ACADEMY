...
@Component({
  selector: 'app-operations-de-consultations',
  templateUrl: './operations-de-consultations.component.html',
  styleUrls: ['./operations-de-consultations.component.scss']
})
export class OperationsDeConsultationsComponent {
  title!: string;
  typeMenuID!: number;
  agent!: Agent
