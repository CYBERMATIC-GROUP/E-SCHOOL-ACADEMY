...
@Component({
  selector: 'app-personnaliser-image',
  templateUrl: './personnaliser-image.component.html',
  styleUrls: ['./personnaliser-image.component.scss']
})
export class PersonnaliserImageComponent {
...
onEditorInput() {
  ...
  readMessagebytypecertificatandpersonne() {
    ...
    if (this.typepersonne == 1 && this.typecertificat == 1) {
      this.Titre =
        'Personnaliser les images de fond bulletin pour les garçons';
    }
    if (this.typepersonne == 1 && this.typecertificat == 2) {
      this.Titre =
        'Personnaliser les images de fond cartes scolaires pour les garçons';
    }
    if (this.typepersonne == 1 && this.typecertificat == 3) {
      this.Titre =
        "Personnaliser le texte des certificats de d'Inscription pour les garçons";
    }
    //filles
    if (this.typepersonne == 2 && this.typecertificat == 1) {
      this.Titre =
        'Personnaliser les images de fond bulletin pour les filles';
    }
    if (this.typepersonne == 2 && this.typecertificat == 2) {
      this.Titre =
        'Personnaliser les images de fond cartes scolaires pour les filles';
    }
    if (this.typepersonne == 2 && this.typecertificat == 3) {
      this.Titre =
        "Personnaliser le texte des certificats de d'Inscription pour les filles";
    }
    ...
    if (this.typepersonne == 0 && this.typecertificat == 1) {
      this.Titre =
        "Personnaliser les images de fond bulletin pour les garçons et filles";
    }
    if (this.typepersonne == 0 && this.typecertificat == 2) {
      this.Titre =
        "Personnaliser les images de fond cartes scolaires pour les garçons et filles";
    }
    if (this.typepersonne == 0 && this.typecertificat == 3) {
      this.Titre =
        "Personnaliser le texte des certificats d'Inscription pour les garçons et filles";
    }
  }
  ...
  UpdateData(){
    ...
    this.isLoading = true
    console.log(ObjectUpdatesend);
    this.eleveService.updateDocumentPersonnaliser(ObjectUpdatesend).subscribe((data)=>{
      console.log(data);
      this.isLoading = false
      this.globalService.reloadComponent('/personalisation-certificat/'+ this.typecertificat + '/' + this.typepersonne)
