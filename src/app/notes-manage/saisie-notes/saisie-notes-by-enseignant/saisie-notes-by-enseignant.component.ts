...
import { EleveNote ,  Note,
  NoteModelCreateOrUpdate,
  TabConfigNote,
  TabNote,} from '../../models/notes.model';
...
@Component({
  selector: 'app-saisie-notes-by-enseignant',
  templateUrl: './saisie-notes-by-enseignant.component.html',
  styleUrls: ['./saisie-notes-by-enseignant.component.scss']
})
export class SaisieNotesByEnseignantComponent {
